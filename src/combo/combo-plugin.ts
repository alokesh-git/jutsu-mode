...
export class ComboPlugin implements Plugin {
    ...
    public onjutsupowerStart(combo: number): void {
        this.plugins.forEach(plugin => plugin.onjutsupowerStart(combo));
    }

    public onjutsupowerStop(combo: number): void {
        this.plugins.forEach(plugin => plugin.onjutsupowerStop(combo));
    }
    ...
    public onDidChangeTextDocument(data: jutsupowerChangeTextDocumentEventData, event: vscode.TextDocumentChangeEvent): void {
